...
document.addEventListener("DOMContentLoaded", function () {
  ...
  /* ---------- 3. quote form ---------- */
  // Where quote requests are addressed. Changing this line is what
  // actually redirects the email; the address shown in index.html is
  // display text only, so update both together.
  var QUOTE_RECIPIENT_EMAIL = "paintseidonllc@gmail.com";
  ...
  if (form) {
    form.addEventListener("submit", function (event) {
      ...
      if (!address) missing.push("Property address / ZIP code");
      ...
      var subject = "Website quote request from " + name;
      ...
      var bodyLines = [
        ...
        "Property address / ZIP code: " + address,
